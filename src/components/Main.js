...
const Main = (props) => {
  ...
  useEffect(() => {
    ...
    const getNewTwoSnowLowerStation = calNewSnowLastDay(
      newTwoDaySnowLowerStation
    );
    const getNewLastWeekSnowLowerStation = calNewSnowLastDay(
      newLastWeekSnowLowerStation
    );
    const sumNewSnowLowerStation = getNewSnowLowerStation.reduce(
      (a, b) => a + b,
      0
    );
    const sumNewTwoDaySnowLowerStation = getNewTwoSnowLowerStation.reduce(
      (a, b) => a + b,
      0
    );
    const sumNewLastWeekSnowLowerStation = getNewLastWeekSnowLowerStation.reduce(
      (a, b) => a + b,
      0
    );
  ...
  useEffect(() => {
    ...
    const getNewTwoSnowUpperStation = calNewSnowLastDay(
      newTwoDaySnowUpperStation
    );
    const getNewLastWeekSnowUpperStation = calNewSnowLastDay(
      newLastWeekSnowUpperStation
    );
    const sumNewSnowUpperStation = getNewSnowUpperStation.reduce(
      (a, b) => a + b,
      0
    );
    const sumNewTwoDaySnowUpperStation = getNewTwoSnowUpperStation.reduce(
      (a, b) => a + b,
      0
    );
    const sumNewLastWeekSnowUpperStation = getNewLastWeekSnowUpperStation.reduce(
      (a, b) => a + b,
      0
    );
  ...
  const lowerStationNewSnowLastTwoDay =
    newSnow && newSnow.lowerStationLastTwoDay;
